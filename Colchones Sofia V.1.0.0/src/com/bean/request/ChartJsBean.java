...
public class ChartJsBean implements Serializable {
	...
	private HorizontalBarChartModel horizontal_chart_model_cliente_cantidad_venta;
	private HorizontalBarChartModel horizontal_chart_model_cliente_total_venta;
	 ...
	 */
	public void horizontalChartModelClienteCantidadVenta() {
		// INIT
		this.horizontal_chart_model_cliente_cantidad_venta = new HorizontalBarChartModel();
		ChartData data = new ChartData();
		...
		/* TITLE */
		hbarDataSet.setLabel("Cantidad Ventas");
		...
		data.setLabels(labels);
		horizontal_chart_model_cliente_cantidad_venta.setData(data);
		...
		horizontal_chart_model_cliente_cantidad_venta.setOptions(options);
	}

	/**
	 * Metodo que permite conocer la plata que deja los clientes en la empresa.
	 */
	public void horizontalChartModelClienteTotalVenta() {
		// INIT
		this.horizontal_chart_model_cliente_total_venta = new HorizontalBarChartModel();
		ChartData data = new ChartData();
		...
		/* TITLE */
		hbarDataSet.setLabel("Dinero Ventas");
		...
		data.setLabels(labels);
		horizontal_chart_model_cliente_total_venta.setData(data);
		...
		horizontal_chart_model_cliente_total_venta.setOptions(options);
	}
	...
	public HorizontalBarChartModel getHorizontal_chart_model_cliente_cantidad_venta() {
		this.horizontalChartModelClienteCantidadVenta();
		return horizontal_chart_model_cliente_cantidad_venta;
	}
	public HorizontalBarChartModel getHorizontal_chart_model_cliente_total_venta() {
		this.horizontalChartModelClienteTotalVenta();
		return horizontal_chart_model_cliente_total_venta;
	}
	...
	public void setHorizontal_chart_model_cliente_cantidad_venta(
			HorizontalBarChartModel horizontal_chart_model_cliente_cantidad_venta) {
		this.horizontal_chart_model_cliente_cantidad_venta = horizontal_chart_model_cliente_cantidad_venta;
	}

	public void setHorizontal_chart_model_cliente_total_venta(
			HorizontalBarChartModel horizontal_chart_model_cliente_total_venta) {
		this.horizontal_chart_model_cliente_total_venta = horizontal_chart_model_cliente_total_venta;
	}
